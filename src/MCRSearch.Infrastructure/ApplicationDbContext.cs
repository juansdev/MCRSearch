    ...
    public class ApplicationDbContext: IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AvailableVehicle>().HasData(
                ...
                new AvailableVehicle { Id = 4, VehicleId = 4, PickUpCityId = 1, ReturnCityId = 1 },
                ...
                new AvailableVehicle { Id = 7, VehicleId = 7, PickUpCityId = 1, ReturnCityId = 2 },
                new AvailableVehicle { Id = 8, VehicleId = 8, PickUpCityId = 2, ReturnCityId = 1 },
                new AvailableVehicle { Id = 9, VehicleId = 9, PickUpCityId = 3, ReturnCityId = 3 },
                new AvailableVehicle { Id = 10, VehicleId = 10, PickUpCityId = 3, ReturnCityId = 3 },
                new AvailableVehicle { Id = 11, VehicleId = 11, PickUpCityId = 3, ReturnCityId = 3 },
                new AvailableVehicle { Id = 12, VehicleId = 12, PickUpCityId = 3, ReturnCityId = 3 },
                new AvailableVehicle { Id = 13, VehicleId = 13, PickUpCityId = 4, ReturnCityId = 3 },
                new AvailableVehicle { Id = 14, VehicleId = 14, PickUpCityId = 4, ReturnCityId = 3 },
                new AvailableVehicle { Id = 15, VehicleId = 15, PickUpCityId = 4, ReturnCityId = 3 },
                new AvailableVehicle { Id = 16, VehicleId = 16, PickUpCityId = 4, ReturnCityId = 3 },
                new AvailableVehicle { Id = 17, VehicleId = 17, PickUpCityId = 2, ReturnCityId = 2 },
                new AvailableVehicle { Id = 18, VehicleId = 18, PickUpCityId = 2, ReturnCityId = 2 },
